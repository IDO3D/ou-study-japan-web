      ...
      <div className="bg-black min-h-screen text-white selection:bg-[#E02424] selection:text-white font-sans overflow-x-hidden">
        ...
        <section ref={heroRef} className="relative min-h-screen w-full flex items-center overflow-hidden pt-24 pb-16 z-10">
          ...
          <motion.div
            ...
            className="absolute bottom-6 sm:bottom-10 right-4 sm:right-6 lg:right-16 z-20 w-[65vw] max-w-[240px] sm:max-w-none sm:w-[340px] bg-[#0c0c0e]/80 backdrop-blur-md p-3 sm:p-5 flex items-center gap-2 sm:gap-5 hover:bg-black transition-colors border border-white/5 shadow-2xl group"
          >
