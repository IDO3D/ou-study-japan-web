    ...
    <>
      ...
      <div className="bg-black min-h-screen text-white selection:bg-[#E02424] selection:text-white font-sans overflow-x-hidden">
        ...
        <section ref={heroRef} className="relative min-h-screen w-full flex items-center overflow-hidden pt-24 pb-16 z-10">
          ...
          {/* Bottom Right Card (Student Testimony Blog Post) */}
          <Link href="/testimonies" passHref legacyBehavior>
            <motion.a
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 1.2, duration: 1 }}
              className="absolute bottom-6 sm:bottom-10 right-4 sm:right-6 lg:right-16 z-20 w-[65vw] max-w-[240px] sm:max-w-none sm:w-[340px] bg-[#0c0c0e]/80 backdrop-blur-md p-3 sm:p-5 flex items-center gap-2 sm:gap-5 hover:bg-black transition-colors border border-white/5 shadow-2xl group cursor-pointer block"
            >
              <div className="flex-1 pr-1 sm:pr-0">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
                  <div className="w-3.5 h-3.5 sm:w-5 sm:h-5 rounded-full overflow-hidden border border-[#E02424]/50">
                    <img src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" className="w-full h-full object-cover" />
                  </div>
                  <span className="text-[7px] sm:text-[9px] font-black text-[#E02424] tracking-widest uppercase">Student Stories</span>
                </div>
                <p className="text-[9px] sm:text-[11px] font-medium text-white/90 leading-snug mb-2 sm:mb-3 italic">
                  "Kyoto feels like home. The absolute best semester of my life!"
                </p>

                <div className="flex items-center gap-3 sm:gap-4 text-white/50 pt-0.5">
                  <button className="hover:text-[#E02424] transition-colors flex items-center gap-1 active:scale-90 group/btn">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="sm:w-[14px] sm:h-[14px] group-hover/btn:fill-[#E02424]/30"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                    <span className="text-[7px] sm:text-[10px] font-bold">124</span>
                  </button>
                  <button className="hover:text-white transition-colors flex items-center gap-1 active:scale-90">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="sm:w-[14px] sm:h-[14px]"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                    <span className="text-[7px] sm:text-[10px] font-bold">12</span>
                  </button>
                  <button className="hover:text-white transition-colors flex items-center gap-1 active:scale-90 ml-auto mr-1">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="sm:w-[14px] sm:h-[14px]"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"></line><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"></line></svg>
                  </button>
                </div>
              </div>
              <div className="w-12 h-16 sm:w-20 sm:h-24 bg-white/5 overflow-hidden relative rounded-sm flex-shrink-0 cursor-pointer border border-white/10">
                <img src="https://images.unsplash.com/photo-1545569341-9eb8b30979d9?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt="Student" />
