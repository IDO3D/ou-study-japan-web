  ...
  return (
    <>
      ...
      <div className="bg-black min-h-screen text-white selection:bg-[#E02424] selection:text-white font-sans overflow-x-hidden">
        ...
        <section id="features" className="relative z-20 bg-[#060608] py-24 sm:py-32 px-6 lg:px-12 border-t border-white/10">
        ...
        <section id="wallet" className="bg-black py-24 px-6 lg:px-12 relative overflow-hidden border-t border-white/5">
