      ...
      <motion.div variants={stagger.item}>
        <div className="p-6 rounded-3xl relative overflow-hidden"
          ...
          <div className="relative z-10">
            ...
            <div className="mb-1">
              <span className="font-display font-black text-[color:var(--text)]" style={{ fontSize: '3rem', letterSpacing: '-0.04em' }}>
                {formatJpy(remaining)}
              </span>
            </div>
      ...
      {restaurants.length > 0 && (
        <motion.div variants={stagger.item}>
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-display font-bold text-[color:var(--text)]" style={{ fontSize: '15px' }}>Nearby Eats</h3>
              ...
              <button key={r.id} onClick={() => onNavigate('discover')}
                ...
                <div className="relative h-24">
                  ...
                  <div className="absolute bottom-2 left-2">
                    <span className="font-display font-black text-[color:var(--text)]" style={{ fontSize: '11px' }}>{formatJpy(r.price_jpy)}</span>
                  </div>
                  {r.is_halal && (
                ...
                <div className="p-2.5" style={{ background: 'rgba(18,18,20,0.97)' }}>
                  <h4 className="font-display font-bold text-[color:var(--text)] truncate" style={{ fontSize: '11px' }}>{r.name}</h4>
        ...
        <div className="p-4 rounded-2xl flex items-center justify-between"
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="font-mono font-bold text-[color:var(--text)]" style={{ fontSize: '14px' }}>¥1,000 = ${(1000 * exchangeRate).toFixed(2)}</p>
            </div>
          </div>
