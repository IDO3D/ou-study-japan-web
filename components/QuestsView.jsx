        ...
        <div className="relative h-36">
          ...
          {quest.isRequired && (
            <div className="absolute top-3 left-3">
              <span className="badge badge-brand text-[9px]">★ Required</span>
            </div>
          )}
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 flex items-end justify-between">
            ...
            {isCompleted ? (
              ...
              <div className="px-2.5 py-1.5 rounded-full"
                ...
                <span className="text-xs font-display font-black text-white">★ {quest.points}</span>
              </div>
            )}
          </div>
        </div>
...
export default function QuestsView() {
  ...
  const handleComplete = (quest) => {
    ...
    toast.success(`+${quest.points} pts! 🎉`, {
  ...
  const TABS = [
    { key: 'explore', label: '🗺️ Explore', count: exploreQuests.length },
    { key: 'program', label: '🎓 Program', count: programQuests.length },
    { key: 'excursions', label: '✈️ Itinerary', count: EXCURSIONS.length },
  ]
      ...
      {tab === 'excursions' && (
        <div className="space-y-4">
          <div className="p-3.5 rounded-2xl"
            ...
            <p className="text-xs font-display font-bold text-white mb-1">✈️ Your 24-Night Journey</p>
          ...
          <div className="p-4 rounded-2xl"
            ...
            {[
              { icon: '🗺️', text: 'Orientation tours in Kyoto and Tokyo' },
              { icon: '🍵', text: 'Tea ceremony experience' },
              { icon: '⛩️', text: 'Visits to temples and shrines' },
              { icon: '🏢', text: 'Business site visits (MKT 3013)' },
              { icon: '🎤', text: 'Guest lecturers (MKT 3013 & MKT 3513)' },
            ].map(item => (
